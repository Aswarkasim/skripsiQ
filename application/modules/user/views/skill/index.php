<section class="jobguru-top-job-area browse-page">
    <div class="container">
                ...
                <div class="browse-job-head-option">
                    <div class="job-browse-action">
                        ...
                        <div class="job-browse-search">
                            <form action="<?= base_url('user/skill/cari') ?>" method="post">
                                <input type="search" placeholder="Search Jobs Here..." name="keyword">
        ...
        <br>
        <strong>
            <p>Sebanyak <?= count($skill) ?> skill ditemukan</p>
        </strong>
        </br>
        <div class="row">
                    ...
                    <div class="sigle-top-job">
                        ...
                        <div class="top-job-company-desc">
                            ...
                            <div class="top-job-company-btn">
                                <a href="<?= base_url('user/skill/detail/' . $row->id_skill) ?>" class="jobguru-btn-2">Lihat Detail</a>
                            </div>
                        </div>
                    </div>
                </div>
