<div class="card card-white single-candidate-widget">
    <?php echo $this->session->userdata('id_job'); ?>
    <div class="container">
        <div class="row">
            <div class="col-md-11 col-lg-12">
                <div class="py-4">
                    <b>
                        <a href="<?= base_url('user/job/edit/' . $job->id_job) ?>" class="btn btn-success btn-sm"><i class="fa fa-pencil"></i><b> Edit</b></a>
                        <a href="<?= base_url('user/job/delete/' . $job->id_job) ?>" class="btn btn-danger btn-sm tombol-hapus"><i class="fa fa-trash"></i><b> Hapus</b></a>
                    </b>
                </div>
            </div>
        </div>
                        ...
                        <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img class="d-block w-100" src="<?= base_url('assets/uploads/job/' . $job->gambar) ?>" alt="First slide">
                                </div>
                                <?php foreach ($gambar as $row) { ?>
                                    <div class="carousel-item">
                                        <img class="d-block w-100" src="<?= base_url('assets/uploads/job/' . $row->gambar) ?>" alt="First slide">
                                    </div>
                                <?php } ?>
                            </div>
