...
<div class="box">
    ...
    <div class="box-body">
        ...
        <table class="table DataTable">
            ...
            <tbody id="targetData">
                <?php $no = 1;
                foreach ($multiuser as $row) { ?>
                    <tr>
                        <td><?= $no ?></td>
                        <td>
                            <strong><a href="<?= base_url('admin/multiuser/detail/' . $row->id_user) ?>"><?= $row->namalengkap ?></a></strong><br>
                        ...
                        <td>
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu" role="menu">
                                    ...
                                    <li><a href="<?= base_url($edit . $row->id_user)  ?>"><i class="fa fa-eye"></i> Non-Aktifkan</a></li>
