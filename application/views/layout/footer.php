                ...
                <div class="col-lg-3 col-md-6">
                    <div class="single-footer-widget">
                        <div class="footer-logo">
                            <a href="index.html">
                                <img src="<?= base_url() ?>assets/fe/img/logo.png" alt="jobguru logo" />
                            </a>
                        </div>
                    ...
                    <div class="single-footer-widget">
                        ...
                        <div class="latest-post-footer clearfix">
                            <div class="latest-post-footer-left">
                                <img src="<?= base_url() ?>assets/fe/img/footer-post-2.jpg" alt="post" />
                            </div>
                        ...
                        <div class="latest-post-footer clearfix">
                            <div class="latest-post-footer-left">
                                <img src="<?= base_url() ?>assets/fe/img/footer-post-3.jpg" alt="post" />
                            </div>
                            <div class="latest-post-footer-right">
...
<!--Popper js-->
<script src="<?= base_url() ?>assets/fe/js/popper.min.js"></script>
<!--Bootstrap js-->
<script src="<?= base_url() ?>assets/fe/js/bootstrap.min.js"></script>
<!--Bootstrap Datepicker js-->
<script src="<?= base_url() ?>assets/fe/js/bootstrap-datepicker.min.js"></script>
<!--Perfect Scrollbar js-->
<script src="<?= base_url() ?>assets/fe/js/jquery-perfect-scrollbar.min.js"></script>
<!--Owl-Carousel js-->
<script src="<?= base_url() ?>assets/fe/js/owl.carousel.min.js"></script>
<!--SlickNav js-->
<script src="<?= base_url() ?>assets/fe/js/jquery.slicknav.min.js"></script>
<!--Magnific js-->
<script src="<?= base_url() ?>assets/fe/js/jquery.magnific-popup.min.js"></script>
<!--Select2 js-->
<script src="<?= base_url() ?>assets/fe/js/select2.min.js"></script>
<!--jquery-ui js-->
<script src="<?= base_url() ?>assets/fe/js/jquery-ui.min.js"></script>
<!--Main js-->
